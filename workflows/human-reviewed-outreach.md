...
3. Bind evidence and set `sending_capability` to false.
4. Human chooses:
   - **Approve** — exact draft is eligible for a separate authorized handoff; no send occurs here.
...
Stop on unsupported familiarity, stale role, ambiguity, missing consent context, active wait, do not contact, privacy conflict, or unavailable reviewer. Only corrected evidence or a new documented human decision can reopen review.
